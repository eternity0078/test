            ...
            <div class="block">
              ...
              <div class="block__content">
                ...
                while($comment= mysqli_fetch_assoc($comments))
                {
                  ...
                  <div class="article__image" style="background-image: url(https://ru.gravatar.com/avatar/<?php echo md5($comment['email']); ?>"></div>
                ...
                <form class="form" method="POST" action="/article.php?id=<?php echo $art['id']; ?>#comment-add-form">
                  ...
                  if (isset($_POST['do_post']))
                  {
                    ...
                    if (empty($errors))
                    {
                      ...
                      echo '<span style="color:green;fond-weight:bold; margin-bottom:10px;display:block">Комментарий успешно добавлен!</span>';
                    }else
                    {
                      echo '<span style="color:red;fond-weight:bold; margin-bottom:10px;display:block">'.$errors['0'].'</span>';
                    }
                  }
                  ?>
                  <div class="form__group">
                    <div class="row">
                      <div class="col-md-4">
                        <input type="text" required='' class="form__control" name="name" placeholder="Имя">
                      </div>
                      <div class="col-md-4">
                        <input type="text" required='' class="form__control" name="nickname" placeholder="Никнейм">
                      </div>
                      <div class="col-md-4">
                        <input type="text" required='' class="form__control" name="email" placeholder="Email">
                      </div>
                    </div>
                  </div>
                  <div class="form__group">
